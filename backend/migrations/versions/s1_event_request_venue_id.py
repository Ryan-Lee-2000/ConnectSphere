...
Chained after s1_client_organisations (SPL-45, merged to main) rather than directly after
sprint1_event_request_drafts, since both were independently written against that same
parent and only one can hold that slot; this one is still local/unmerged, so it is the side
that moves.
"""
